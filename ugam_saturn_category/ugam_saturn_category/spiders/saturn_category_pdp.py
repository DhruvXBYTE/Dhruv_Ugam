...
class JSpiderSpider(scrapy.Spider):
    ...
    def __init__(self, start='', end=''):
        ...
        try:
            self.cursor = UgamSaturnCategoryPipeline.cursor
            self.con = UgamSaturnCategoryPipeline.con
            self.start = start
            self.end = end
        ...
        try:
            ...
            for itm in core_list:
                ...
                if os.path.exists(path):
                    ...
                    # print(url_zipcode)
                    re = requests.get(url=product_url, headers=header, verify=False, proxies=proxies)
                    time.sleep(2)
                    re_text1 = re.text
...
if __name__ == '__main__':
    from scrapy.cmdline import execute
    execute('scrapy crawl saturn_category_pdp -a start=12264 -a end=12264'.split())