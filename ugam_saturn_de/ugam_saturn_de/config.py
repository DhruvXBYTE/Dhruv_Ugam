...
db_user = 'root'
db_pass = 'xbyte'
db_category_table = f'category_mpn'
db_name = 'ugam_saturn_de'
...
HTMLs = "D:\\Daily Scheduler\\0. UGAM\\UGAM_Saturn_de\\HTML_SS\\2022_05_31\\HTML"
...
file_handler = logging.FileHandler(Log+f'\\ugam_saturn_de_{date}.log')
